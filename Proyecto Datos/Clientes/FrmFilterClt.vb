Public Class FrmFilterClt
    ...
    Dim TitulosCampos As String() = {"Codigo", "NIF", "Nombre", "Dirección", "DosPos", "Poblac", "Provin", "Tfno", "Fax", "email", "FecAlta", "CodBan", "CosSuc", "DirEnv", "CodFPago"}
    ...
    Public Function CreateFilterQuery(DtsManager As DataSet) As String Implements IFilterForm.CreateFilterQuery
        ...
        Try
            queryFiltro = DtsManager.Tables("clt").Columns(CmbCampos.SelectedIndex).ColumnName 'Obtenemos el nombre de la columna
            Select Case CmbCampos.SelectedIndex
                Case 1, 2, 3, 7, 8, 9 'Para texto
                    ...
                    End Select
                Case 0, 4, 5, 6, 11, 12, 13, 14 'Para numeros
