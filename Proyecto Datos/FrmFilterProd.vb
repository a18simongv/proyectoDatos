...
Public Class FrmFilterProd
    ...
    Public Function CreateFilterQuery(DtsManager As DataSet) As String Implements IFilterForm.CreateFilterQuery
        ...
        Try
            queryFiltro = DtsManager.Tables("Prod").Columns(CmbCampos.SelectedIndex).ColumnName 'Obtenemos el nombre de la columna
            Select Case CmbCampos.SelectedIndex
                Case 1 'Para texto
                    ...
                    End Select
                Case 0, 2, 3, 4, 5, 6, 7, 8 'Para numeros
